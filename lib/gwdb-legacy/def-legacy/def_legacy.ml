...
(** Alias to [Adef_legacy.cdate] *)
type cdate = Adef_legacy.cdate

(** Alias to [Adef_legacy.date] *)
type date =
  Adef_legacy.date =
...
(** Alias to [Adef_legacy.calendar] *)
and calendar = Adef_legacy.calendar = Dgregorian | Djulian | Dfrench | Dhebrew

(** Alias to [Adef_legacy.dmy] *)
and dmy =
  Adef_legacy.dmy =
    { day : int; month : int; year : int; prec : precision; delta : int }

(** Alias to [Adef_legacy.dmy2] *)
and dmy2 = Adef_legacy.dmy2 = { day2 : int; month2 : int; year2 : int; delta2 : int }

(** Alias to [Adef_legacy.precision] *)
and precision =
  Adef_legacy.precision =
      Sure
    | About
    | Maybe
    | Before
...
type 'family gen_ascend = { parents : 'family option; consang : Adef_legacy.fix }
...
(** Alias to [Adef_legacy.gen_couple] *)
type 'person gen_couple = 'person Adef_legacy.gen_couple
